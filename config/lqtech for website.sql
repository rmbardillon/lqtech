...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2023 at 07:45 AM
...
CREATE TABLE `action_logs` (
  `ACTION_LOG_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
...
CREATE TABLE `installation_form` (
  `INSTALLATION_FORM_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
  ...
  `JOB_ORDER_NUMBER` varchar(64) NOT NULL,
...
CREATE TABLE `models` (
  `MODEL_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
...
CREATE TABLE `products` (
  `PRODUCT_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
  `PRODUCT_DETAILS_ID` varchar(64) NOT NULL,
  `SKU` varchar(32) NOT NULL,
  `SERIAL_NUMBER` varchar(32) NOT NULL,
  `DATE_INSERTED` datetime NOT NULL DEFAULT current_timestamp(),
  `DATE_OUT` datetime DEFAULT NULL,
  `STATUS` varchar(64) NOT NULL DEFAULT 'IN'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `product_details` (
  `PRODUCT_DETAILS_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
...
CREATE TABLE `sales` (
  `SALE_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
  `INSTALLATION_FORM_ID` varchar(64) NOT NULL,
  `PRODUCT_DETAILS_ID` varchar(64) NOT NULL,
  `SERIAL_NUMBER` varchar(32) NOT NULL,
  `SKU` varchar(32) NOT NULL,
...
CREATE TABLE `stocks` (
  `STOCKS_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
...
CREATE TABLE `users` (
  `USER_ID` varchar(64) NOT NULL DEFAULT replace(convert(uuid() using utf8mb4),'-',''),
...
('58727a89cdf911ed', 'JOHN', 'DOE', 'owner', '$2y$10$NNjsc/qfqw0VhWXnVXwI4e7epUme3YfQlyWpaXcMdpHqjRvp721ze', 1, 0, 0, '2023-05-04 12:11:06');
