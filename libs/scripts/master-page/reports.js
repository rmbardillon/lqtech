$(document).ready(function() {
    ...
    $("#generateReport").click(function() {
        ...
        if(fromDate == "" || toDate == "" || selectReport == null) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if(data == "[]") {
                            ...
                            window.open("../report/product-inventory-report-out.php?from=" + fromDate + "&to=" + toDate, "_blank");
                        }
                    },
                    error: function() {
                        swal.fire({
            ...
            } else if(selectReport == "1.1") {
                $.ajax({
                    url: REPORT_CONTROLLER + "?action=1.1",
                    type: "POST",
                    data: {
                        fromDate: fromDate,
                        toDate: toDate
                    ...
                    success: function(data) {
                        ...
                        if(data == "[]") {
                            ...
                            window.open("../report/product-inventory-report-in.php?from=" + fromDate + "&to=" + toDate, "_blank");
                        }
                    },
                    error: function() {
                        swal.fire({
